...
namespace BackgroundJobsScheduler.Common
{
    public class AcessoCidadaoClientAccessToken : IClientAccessTokenProvider
    {
        ...
        {
            _clientId = Environment.GetEnvironmentVariable("BackgroundJobsSchedulerClientId");
            _secret = Environment.GetEnvironmentVariable("BackgroundJobsSchedulerSecret");
        ...
        private async Task SetAccessTokenAsync(DateTime now)
        {
            ...
            try
            {
                ...
                {
                    TokenResponse tokenResponse = await GetProcessoEletronicoAccessTokenAsync();
        ...
        private async Task<TokenResponse> GetProcessoEletronicoAccessTokenAsync()
        {
            ...
            return await tokenClient.RequestClientCredentialsAsync("ApiProcessoEletronico");
        }
    }
}
